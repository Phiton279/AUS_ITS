...
<html>
	<head>
		<title>Admin Page | Add New Item</title>
			...
			<div class="col-md-10">
				...
				<?= form_open_multipart('admin/products/create', ['class'=>'form-horizontal']) ?>
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-10">
						  <input type="text" class="form-control" name="universitas" placeholder="" value="<?= set_value('universitas') ?>">
						</div>
					  </div>
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-10">
						  <input type="text" class="form-control" name="type" placeholder="" value="<?= set_value('type') ?>">
						</div>
					  </div>
